...
impl crate::substrate::ObservationSubstrate for RepeatedRunSubstrate {
    ...
    fn judge(
        ...
        let cluster_strength = evidence::strength(runs, stats.lexical_units, convention_rate, z);
...
pub fn repeated_run_findings(corpus: &Corpus, cfg: &RepeatedCharacterRunConfig) -> Vec<Finding> {
    let mut cache = crate::substrate::SubstrateCache::new();
    let mut out = Vec::new();
