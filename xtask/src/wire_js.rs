...
use ssc_wire::schema::{WireSchema, schema};

const BANNER: &str = "// @generated by `cargo xtask wire-js` from ssc-wire's schema. DO NOT EDIT.\n// The reviewed decoder/reconciler lives in the hand-written findings.js.\n";
...
fn render_generated_js(s: &WireSchema) -> String {
    ...
    let sev = s
        ...
        .join(", ");
    out.push_str(&format!(
        "export const SEVERITIES = Object.freeze([{sev}]);\n\n"
    ));
...
mod tests {
    ...
    fn committed_generated_files_match_render() {
        ...
        for (name, content) in [
            ...
            assert_eq!(
                committed, content,
                "{name} is stale — run `cargo xtask wire-js`"
            );
        }
    }
}
