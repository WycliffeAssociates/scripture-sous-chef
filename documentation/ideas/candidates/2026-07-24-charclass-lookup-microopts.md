...
**Reclassified to `candidates/` 2026-07-29 (owner ruling).** The live thread
is the SWAR/SIMD tape classifier: ~3.2× on Latin, a net loss on
Devanagari/Han as spiked. Candidate condition: a SIMD classification shape
that holds on largely non-ASCII text, or a cheap script-dispatch that falls
back without paying for the check on non-Latin corpora. Start from the spike
tables, not from scratch.
